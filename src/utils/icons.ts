...
export const iconList: IconItem[] = [
  // 네비게이션
  { name: 'LayoutDashboard', label: 'Dashboard', category: '네비게이션', component: markRaw(LayoutDashboard) },
  { name: 'Home', label: 'Home', category: '네비게이션', component: markRaw(Home) },
  { name: 'Menu', label: 'Menu', category: '네비게이션', component: markRaw(Menu) },
  { name: 'ChevronRight', label: 'Chevron Right', category: '네비게이션', component: markRaw(ChevronRight) },
  { name: 'ArrowLeft', label: 'Arrow Left', category: '네비게이션', component: markRaw(ArrowLeft) },
  { name: 'ExternalLink', label: 'External Link', category: '네비게이션', component: markRaw(ExternalLink) },
  { name: 'Navigation', label: 'Navigation', category: '네비게이션', component: markRaw(Navigation) },
  ...
  { name: 'ClipboardList', label: 'Clipboard List', category: '콘텐츠', component: markRaw(ClipboardList) },
  ...
  { name: 'MessageSquare', label: 'Message', category: '커뮤니케이션', component: markRaw(MessageSquare) },
  ...
  { name: 'UserCheck', label: 'User Check', category: '커뮤니케이션', component: markRaw(UserCheck) },
  ...
  { name: 'TrendingUp', label: 'Trending Up', category: '비즈니스', component: markRaw(TrendingUp) },
  { name: 'DollarSign', label: 'Dollar Sign', category: '비즈니스', component: markRaw(DollarSign) },
  { name: 'ShoppingCart', label: 'Shopping Cart', category: '비즈니스', component: markRaw(ShoppingCart) },
  { name: 'CreditCard', label: 'Credit Card', category: '비즈니스', component: markRaw(CreditCard) },
